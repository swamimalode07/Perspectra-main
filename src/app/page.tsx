...
export default function Home() {
  const { messages, problem, setProblem, addMessage, isLoading, setIsLoading } = useConversationStore();
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 flex">
            ...
            {(viewMode === 'split' || viewMode === 'chat') && (
              <div className={`${viewMode === 'split' ? 'w-1/2' : 'w-full'} flex flex-col border-r border-white/10`}>
                {/* Messages */}
            ...
            {(viewMode === 'split' || viewMode === 'canvas') && (
              <div className={`${viewMode === 'split' ? 'w-1/2' : 'w-full'} p-6`}>
                <ConversationCanvas
                  messages={messages}
